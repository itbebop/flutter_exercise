...
class HomeBodyPopularItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("popularWidth : $popularItemWidth");

    return Padding(
      padding: const EdgeInsets.only(bottom: gap_xl),
      child: Container(
        constraints: BoxConstraints(
          minWidth: 310, // 가장 작은 핸드폰 사이즈가 320
        ),
        child: SizedBox(
  ...
  Widget _buildPopularItemComment() {
    return Column(
      children: [
        Text(
          "깔끔하고 다 갖춰져있어서 좋았어요:) 위치도 완전 좋아용 다들 여기 살고싶다구ㅋㅋㅋㅋㅋ 화장실도 3개에요!! 5명이서 씻는것도 전혀 불편함 없이 좋았어요^^ 이불도 포근하고 좋습니다ㅎㅎ",
          style: body1(),
          maxLines: 3,
          overflow: TextOverflow.ellipsis, // text가 넘어가면 ... 으로 생략해줌
        ),
        SizedBox(
          height: gap_s,
        )
